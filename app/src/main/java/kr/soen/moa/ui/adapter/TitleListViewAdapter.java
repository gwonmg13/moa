...
public class TitleListViewAdapter extends BaseAdapter  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tsLikesCounter = (TextView) convertView.findViewById(R.id.tsLikesCounter);
        ...
        //아이템 내 각 위젯에 데이터 반영
        titleContent.setText(titleListViewItem.getContent());
        //int likeNum = titleListViewItem.getLikeNum();

        tsLikesCounter.setText(Integer.toString(titleListViewItem.getLikeNum()));
